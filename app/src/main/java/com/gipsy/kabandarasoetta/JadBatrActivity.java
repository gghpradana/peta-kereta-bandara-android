...
public class JadBatrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jad_batr);

        recyclerView = findViewById(R.id.rv_jadbat2keb);
        recyclerView1 = findViewById(R.id.rv_jadbat2ked);
    ...
    private void getData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                try {
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        jadKeb.setJadwalKeb(data.getString("KEBERANGKATAN").replace(":00", " Menuju ST. Duri"));

                        JadKed jadKed = new JadKed();
                        jadKed.setJadwalKed(data.getString("KEDATANGAN").replace(":00"," Tiba dari ST. Bandara"));
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder builder = new AlertDialog.Builder(JadBatrActivity.this);
