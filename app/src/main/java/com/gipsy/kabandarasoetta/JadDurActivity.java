...
public class JadDurActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jad_dur);

        recyclerView = findViewById(R.id.rv_jaddurkeb);
        recyclerView1 = findViewById(R.id.rv_jaddurked);
    ...
    private void getData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                try {
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        jadKeb.setJadwalKeb(data.getString("KEBERANGKATAN").replace(":00", " Menuju ST. Bandara"));

                        JadKed jadKed = new JadKed();
                        jadKed.setJadwalKed(data.getString("KEDATANGAN").replace(":00"," Tiba dari ST. BNI City"));
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder builder = new AlertDialog.Builder(JadDurActivity.this);
