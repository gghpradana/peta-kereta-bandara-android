...
public class JadBatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jad_bat);

        recyclerView = findViewById(R.id.rv_jadbatkeb);
        recyclerView1 = findViewById(R.id.rv_jadbatked);
    ...
    private void getData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder builder = new AlertDialog.Builder(JadBatActivity.this);
