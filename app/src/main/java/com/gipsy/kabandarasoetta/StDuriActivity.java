...
public class StDuriActivity extends AppCompatActivity implements OnMapReadyCallback {

    CollapsingToolbarLayout collapsingToolbarLayout;
    private GoogleMap mMap;
    private ViewPager viewPager;
    private CircleIndicator circleIndicator;
    private GamDurAdapter gamDurAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_st_duri);

        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapdur);
        ...
        gamDurAdapter = new GamDurAdapter(this);
        viewPager = findViewById(R.id.vpgambar);
        viewPager.setAdapter(gamDurAdapter);
    ...
    private void getDuri() {
        final ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Loading...");
        progressDialog.show();

        String url = "https://gipsygis.000webhostapp.com/api/gipsy/getduri.php";
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(StDuriActivity.this);
