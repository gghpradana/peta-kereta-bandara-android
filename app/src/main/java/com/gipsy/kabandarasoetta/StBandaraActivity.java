...
public class StBandaraActivity extends AppCompatActivity implements OnMapReadyCallback {

    CollapsingToolbarLayout collapsingToolbarLayout;
    private GoogleMap mMap;
    private ViewPager viewPager;
    private CircleIndicator circleIndicator;
    private GamBanAdapter gamBanAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_st_bandara);

        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapban);
        ...
        gamBanAdapter = new GamBanAdapter(this);
        viewPager = findViewById(R.id.vpgambar);
        viewPager.setAdapter(gamBanAdapter);
    ...
    private void getBandara() {
        final ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Loading...");
        progressDialog.show();

        String url = "https://gipsygis.000webhostapp.com/api/gipsy/getbandara.php";
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(StBandaraActivity.this);
