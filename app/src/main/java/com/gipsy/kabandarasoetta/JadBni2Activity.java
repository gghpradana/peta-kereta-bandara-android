...
public class JadBni2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jad_bni2);

        recyclerView = findViewById(R.id.rv_jadbni2);
    ...
    private void getData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder builder = new AlertDialog.Builder(JadBni2Activity.this);
