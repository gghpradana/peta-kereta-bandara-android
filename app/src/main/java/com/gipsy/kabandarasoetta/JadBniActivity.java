...
public class JadBniActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jad_bni);

        Toolbar toolbar = findViewById(R.id.toolbarganteng);

        recyclerView = findViewById(R.id.rv_jadbnikeb);
        recyclerView1 = findViewById(R.id.rv_jadbniked);
    ...
    private void getData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
            ...
            public void onResponse(JSONArray response) {
                try {
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        jadKed.setJadwalKed(data.getString("KEDATANGAN").replace(":00"," Tiba dari ST. Bekasi"));
            ...
            public void onErrorResponse(VolleyError error) {
                AlertDialog.Builder builder = new AlertDialog.Builder(JadBniActivity.this);
